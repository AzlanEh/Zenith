  ...
  return (
    <aside className={cn(
      ...
      <div className="p-6 flex items-center gap-3">
        ...
        <div>
          <h1 className="text-xl font-serif-accent font-bold tracking-tight text-foreground">ZenFocus</h1>
          <p className="text-xs text-muted-foreground font-medium uppercase tracking-wider">Digital Wellbeing</p>
        </div>
      </div>
      ...
      <nav className="flex-1 px-4 py-4 flex flex-col gap-1 overflow-y-auto">
        ...
        >
          <LayoutDashboard className={cn("w-5 h-5", currentPage === 'dashboard' ? "text-foreground" : "group-hover:text-foreground transition-colors")} />
        ...
        >
          <Focus className={cn("w-5 h-5", currentPage === 'focus' ? "text-foreground" : "group-hover:text-foreground transition-colors")} />
        ...
        >
          <BarChart2 className={cn("w-5 h-5", currentPage === 'analytics' ? "text-foreground" : "group-hover:text-foreground transition-colors")} />
        ...
        >
          <ShieldAlert className={cn("w-5 h-5", currentPage === 'limits' ? "text-foreground" : "group-hover:text-foreground transition-colors")} />
        ...
        >
          <SettingsIcon className={cn("w-5 h-5", currentPage === 'settings' ? "text-foreground" : "group-hover:text-foreground transition-colors")} />
